...
## BertlClaw — Finanzielles Ziel

- **Mindestziel Selbstständigkeit:** EUR 5.000,— netto pro Monat (nach österr. Steuern und Abgaben)
  - Das ist die Schwelle, ab der Dominic gut davon leben kann
  - Langfristiges Ziel: Vollzeit-Selbstständigkeit mit BertlClaw

## BertlClaw — Strategie

- Ziel: Vollzeit-Selbstständigkeit langfristig (nicht nur Nebeneinkommen)
- **XALAX-Nebentätigkeitsgenehmigung:** Erst beantragen, wenn erster Auftrag gesichert — nicht vorher

## Dominic — Beruflicher Hintergrund
