#!/usr/bin/env node
/**
 * generate-ch-batch2.js
 * Generates city×profession landing pages for 20 Swiss cities × 30 professions.
 * Skips already-existing files. Updates sitemap.xml.
 * New vs generate-ch-expanded.js: adds heilpraktiker, unternehmensberater, ingenieur, projektmanager, hr-berater
 */
...
const professions = [
  ...
  {slug: "heilpraktiker", label: "Heilpraktiker", singular: "Heilpraktiker", emoji: "🌿"},
...
const professionContent = {
  ...
  heilpraktiker: {
    intro: "Heilpraktiker stehen vor der Herausforderung, ihr ganzheitliches Angebot klar und seriös zu kommunizieren — eine professionelle Landingpage schafft genau diese Brücke.",
    detail: "Menschen, die einen Heilpraktiker suchen, wollen oft eine Alternative zur konventionellen Medizin. Wer sein Behandlungskonzept klar darstellt und Vertrauen aufbaut, gewinnt Klienten, die wirklich zur eigenen Praxis passen.",
    value: "BertlClaw entwickelt Landingpages für Heilpraktiker, die Methoden verständlich erklären, das Vertrauen der Klienten gewinnen und den Einstieg in die Behandlung so unkompliziert wie möglich gestalten.",
    chfNote: "Der Schweizer Markt für Naturheilkunde und komplementäre Medizin ist etabliert und kaufkräftig. Eine professionelle Landingpage positioniert dich als vertrauenswürdigen Heilpraktiker in deiner Region.",
  },
  ...
  unternehmensberater: {
    intro: "Unternehmensberater und Business-Coaches sind gefragter denn je — aber im gesättigten Markt gewinnt, wer seine Positionierung auf den Punkt bringt.",
    detail: "CEOs und Geschäftsführer, die einen Unternehmensberater suchen, erwarten Klarheit und Kompetenz vom ersten Online-Kontakt an. Eine Landingpage, die dein Beratungskonzept und deine Erfahrung unmissverständlich kommuniziert, macht den entscheidenden Unterschied.",
    value: "BertlClaw erstellt Landingpages für Unternehmensberater, die Expertise greifbar machen, konkrete Problemlösungen kommunizieren und Entscheider direkt in Erstgespräche führen.",
    chfNote: "Schweizer KMUs und Konzerne investieren substanziell in externe Beratung. Eine professionelle Beratungs-Landingpage öffnet dir Türen zu Mandaten mit attraktiven CHF-Tagessätzen.",
  },
  ingenieur: {
    intro: "Ingenieure und technische Fachleute sind unverzichtbar — aber ihre Selbstvermarktung hinkt oft hinterher. Eine klare Landingpage schließt diese Lücke.",
    detail: "Ob Maschinenbau, Elektrotechnik oder Bauingenieurwesen: Ingenieure, die sich selbstständig machen oder als Freelancer tätig sind, brauchen eine Online-Präsenz, die ihre Fachkompetenz klar und verständlich kommuniziert.",
    value: "BertlClaw entwickelt Landingpages für Ingenieure und technische Freelancer, die komplexe Expertise verständlich darstellen, Projekterfahrungen überzeugend präsentieren und neue Auftraggeber gezielt ansprechen.",
    chfNote: "Der Schweizer Ingenieurmarkt bietet hervorragende Konditionen für Fachleute — mit einer professionellen Landingpage positionierst du dich für attraktive Projekte und CHF-starke Auftraggeber.",
  },
  projektmanager: {
    intro: "Projektmanager sind das Rückgrat erfolgreicher Projekte — und wer als Freelance-PM online sichtbar ist, erhält die besten Mandate.",
    detail: "Unternehmen, die externe Projektmanager suchen, wollen schnell Klarheit: Welche Branchen? Welche Methoden? Welche Erfolge? Eine fokussierte Landingpage liefert genau diese Antworten — und schafft Vertrauen, bevor das erste Gespräch stattfindet.",
    value: "BertlClaw erstellt Landingpages für Projektmanager und PM-Freelancer, die Methodik und Erfahrung klar kommunizieren, Branchenschwerpunkte hervorheben und Interessenten in konkrete Anfragen verwandeln.",
    chfNote: "Schweizer Unternehmen schätzen strukturiertes Projektmanagement und zahlen entsprechend. Eine professionelle PM-Landingpage positioniert dich für hochwertige Mandate im CHF-Markt.",
  },
  "hr-berater": {
    intro: "HR-Berater und Personalberater sind gefragt, wenn Unternehmen wachsen, sich verändern oder Talente suchen — eine klare Landingpage macht dich zur ersten Anlaufstelle.",
    detail: "Personalverantwortliche und Geschäftsführer, die HR-Unterstützung suchen, wollen schnell verstehen, welche Probleme du löst und wie du vorgehst. Eine klare Positionierung auf deiner Landingpage spart Zeit — und gewinnt das Vertrauen der richtigen Kunden.",
    value: "BertlClaw entwickelt Landingpages für HR-Berater, die HR-Expertise verständlich kommunizieren, Beratungsschwerpunkte klar darstellen und Entscheider direkt in Erstgespräche führen.",
    chfNote: "Schweizer Unternehmen investieren in professionelle HR-Beratung — vom Recruiting über Change Management bis zur Organisationsentwicklung. Eine starke Landingpage erschliesst dir Mandate mit attraktiven CHF-Konditionen.",
  },
};
...
// Update sitemap with truly new URLs
