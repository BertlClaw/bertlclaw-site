#!/usr/bin/env node
/**
 * generate-de-batch3.js
 * Generates city×profession landing pages for German cities (batch 3).
 * Cities: 20 (Norddeutschland, Ostdeutschland, Rheinland-Pfalz)
 * Professions: 25
...
const cities = [
  ...
  {city: "Stralsund", slug: "stralsund", state: "Mecklenburg-Vorpommern", locale: "de_DE"},
  ...
  {city: "Dessau", slug: "dessau", state: "Sachsen-Anhalt", locale: "de_DE"},
  {city: "Chemnitz", slug: "chemnitz", state: "Sachsen", locale: "de_DE"},
  {city: "Zwickau", slug: "zwickau", state: "Sachsen", locale: "de_DE"},
  {city: "Görlitz", slug: "goerlitz", state: "Sachsen", locale: "de_DE"},
  {city: "Kaiserslautern", slug: "kaiserslautern", state: "Rheinland-Pfalz", locale: "de_DE"},
  {city: "Koblenz", slug: "koblenz", state: "Rheinland-Pfalz", locale: "de_DE"},
  {city: "Worms", slug: "worms", state: "Rheinland-Pfalz", locale: "de_DE"},
];
...
function getCityFlavor(city) {
  const flavors = {
    kiel: "Kiel als Landeshauptstadt von Schleswig-Holstein ist ein wichtiger Wirtschafts- und Universitätsstandort an der Ostseeküste — mit einer lebhaften Unternehmensszene und wachsender Nachfrage nach professionellen Dienstleistungen.",
    luebeck: "Lübeck, die Hansestadt mit UNESCO-Welterbe-Altstadt, ist ein bedeutendes Wirtschafts- und Kulturzentrum in Schleswig-Holstein — mit einer soliden mittelständischen Unternehmenslandschaft und aufgeschlossenem Markt für Selbstständige.",
    flensburg: "Flensburg als nördlichste Großstadt Deutschlands an der dänischen Grenze ist ein besonderer Wirtschaftsstandort — mit dänischem Einfluss, Rum-Tradition und einer aktiven, gut vernetzten Unternehmensgemeinschaft.",
    rostock: "Rostock ist das wirtschaftliche Zentrum Mecklenburg-Vorpommerns — Hafen, Universität und wachsende Technologieszene machen die Stadt zu einem attraktiven Standort für positionierte Selbstständige.",
    schwerin: "Schwerin als Landeshauptstadt von Mecklenburg-Vorpommern mit dem bekannten Schloss ist ein überschaubarer, aber gut vernetzter Markt — ideal für Selbstständige, die in einer Region mit wenig Konkurrenz stark sichtbar sein wollen.",
    greifswald: "Greifswald mit seiner renommierten Ernst-Moritz-Arndt-Universität ist ein akademisch geprägter Standort in Vorpommern — mit einem aufgeschlossenen, wissensorientierten Markt für qualifizierte Selbstständige.",
    stralsund: "Stralsund als UNESCO-Welterbestadt und Tor zur Insel Rügen verbindet Tourismus mit einer soliden regionalen Wirtschaft — ein Markt mit Potenzial für klar positionierte Selbstständige.",
    erfurt: "Erfurt als Thüringens Landeshauptstadt ist ein bedeutendes Wirtschafts- und Bildungszentrum in Mitteldeutschland — mit wachsender Startup-Szene und steigender Nachfrage nach professionellen Dienstleistungen.",
    jena: "Jena ist Thüringens führende Technologie- und Wissenschaftsstadt — mit Carl Zeiss, Ernst Abbe Stiftung und der Friedrich-Schiller-Universität bietet sie ein einzigartiges Umfeld für innovative Selbstständige.",
    weimar: "Weimar, die Kulturstadt par excellence mit Bauhaus und Klassik-Erbe, ist ein besonderer Standort in Thüringen — mit einem kulturaffinen, kaufkräftigen Umfeld für kreative und wissensintensive Selbstständige.",
    gera: "Gera als zweitgrößte Stadt Thüringens ist ein wichtiger regionaler Wirtschaftsstandort im Osten des Freistaats — mit solider Industrie- und Handwerksbasis und wachsender Dienstleistungsnachfrage.",
    magdeburg: "Magdeburg als Landeshauptstadt von Sachsen-Anhalt ist ein bedeutendes Wirtschaftszentrum an der Elbe — mit der Otto-von-Guericke-Universität, wachsender Industrie und steigendem Bedarf an professionellen Dienstleistungen.",
    halle: "Halle (Saale) ist nach Magdeburg die zweitgrößte Stadt Sachsen-Anhalts und ein bedeutendes Bildungs- und Wirtschaftszentrum — die Martin-Luther-Universität prägt eine lebhafte, vielfältige Unternehmenslandschaft.",
    dessau: "Dessau, weltbekannt durch das Bauhaus und als Gartenreich-Stadt, ist ein kompakter aber gut vernetzter Wirtschaftsstandort in Sachsen-Anhalt — ideal für Selbstständige, die in einer überschaubaren Region Marktführerschaft anstreben.",
    chemnitz: "Chemnitz ist nach Leipzig und Dresden die drittgrößte Stadt Sachsens — mit starker Industrietradition, TU Chemnitz und einer wachsenden Dienstleistungs- und Technologieszene.",
    zwickau: "Zwickau ist vor allem als Automobilstadt (Volkswagen) bekannt, aber auch ein solider regionaler Wirtschaftsstandort in Westsachsen — mit wachsender Nachfrage nach qualifizierten Dienstleistungen.",
    goerlitz: "Görlitz, die östlichste Stadt Deutschlands an der Neiße, ist ein besonderer Standort — die gut erhaltene Altstadt, die Nachbarschaft zu Polen und wachsender Tourismus schaffen ein einzigartiges Umfeld für Selbstständige.",
    kaiserslautern: "Kaiserslautern in der Pfalz ist ein wichtiger Wirtschafts- und Technologiestandort in Rheinland-Pfalz — mit DFKI-Außenstelle, TU Kaiserslautern und einer aktiven mittelständischen Unternehmenslandschaft.",
    koblenz: "Koblenz am Deutschen Eck, wo Rhein und Mosel zusammenfließen, ist ein bedeutendes Wirtschaftszentrum in Rheinland-Pfalz — mit Bundesbehörden, solider Wirtschaft und einer gut vernetzten Unternehmensgemeinschaft.",
    worms: "Worms als eine der ältesten Städte Deutschlands mit Nibelungen-Tradition und dem bekannten Wormser Dom ist ein überschaubarer, aber aktiver Wirtschaftsstandort in Rheinhessen — mit gutem Potenzial für positionierte Selbstständige.",
  };
