#!/usr/bin/env node
/**
 * generate-de-batch8.js
 * Generates city×profession landing pages for German cities (batch 8).
 * Cities: 20 (Bayern remaining + Hessen remaining + Baden-Württemberg remaining)
 * Professions: 25
...
const cities = [
  ...
  {city: "Bayreuth", slug: "bayreuth", state: "Bayern", locale: "de_DE"},
  {city: "Bamberg", slug: "bamberg", state: "Bayern", locale: "de_DE"},
  {city: "Kassel", slug: "kassel", state: "Hessen", locale: "de_DE"},
  {city: "Wiesbaden", slug: "wiesbaden", state: "Hessen", locale: "de_DE"},
  {city: "Darmstadt", slug: "darmstadt", state: "Hessen", locale: "de_DE"},
  {city: "Marburg", slug: "marburg", state: "Hessen", locale: "de_DE"},
  {city: "Gießen", slug: "giessen", state: "Hessen", locale: "de_DE"},
  {city: "Fulda", slug: "fulda", state: "Hessen", locale: "de_DE"},
  {city: "Offenbach", slug: "offenbach", state: "Hessen", locale: "de_DE"},
  {city: "Konstanz", slug: "konstanz", state: "Baden-Württemberg", locale: "de_DE"},
  {city: "Reutlingen", slug: "reutlingen", state: "Baden-Württemberg", locale: "de_DE"},
  {city: "Ludwigsburg", slug: "ludwigsburg", state: "Baden-Württemberg", locale: "de_DE"},
  {city: "Esslingen", slug: "esslingen", state: "Baden-Württemberg", locale: "de_DE"},
  {city: "Sindelfingen", slug: "sindelfingen", state: "Baden-Württemberg", locale: "de_DE"},
];
...
function getCityFlavor(city) {
  const flavors = {
    fuerth: "Fürth ist die zweitgrößte Stadt im Großraum Nürnberg und als Zwillingsstadt der Frankenmetropole eng mit ihr verwachsen — mit einer reichen Industriegeschichte (Quelle, Grundig), einer lebhaften Innenstadt und einer gut vernetzten Mittelstandslandschaft bietet Fürth Selbstständigen einen attraktiven lokalen Markt mit urbanem Anschluss.",
    regensburg: "Regensburg ist UNESCO-Weltkulturerbe und eine der am schnellsten wachsenden Städte Bayerns — als Universitätsstadt mit starker Industriebasis (BMW, Continental, Infineon), hoher Lebensqualität an der Donau und einer wachsenden Startup-Szene bietet Regensburg Selbstständigen ein besonders dynamisches Marktumfeld.",
    ingolstadt: "Ingolstadt ist die Audi-Stadt und eines der wirtschaftsstärksten Zentren Bayerns — mit einem der höchsten Pro-Kopf-Einkommen Deutschlands, starker Industriepräsenz, einer Technischen Hochschule und einer gut situierten Bevölkerung bietet Ingolstadt Selbstständigen Zugang zu einer kaufkräftigen, anspruchsvollen Zielgruppe.",
    wuerzburg: "Würzburg ist die Wein- und Barockstadt am Main und ein wichtiges Bildungs- und Kulturzentrum Unterfrankens — mit Julius-Maximilians-Universität, einer lebhaften Studentenszene, starkem Mittelstand und einer gut vernetzten Unternehmerschaft bietet Würzburg Selbstständigen ein vielfältiges und loyales Kundenpotenzial.",
    erlangen: "Erlangen ist die Siemens-Stadt Bayerns und eine der innovativsten Mittelstädte Deutschlands — mit einem der dichtesten Wissenschafts- und Technologiecluster (Siemens Healthineers, FAU Erlangen-Nürnberg), hoher Kaufkraft und einer gut ausgebildeten Bevölkerung bietet Erlangen Selbstständigen ein ausgezeichnetes Umfeld für hochwertige Dienstleistungen.",
    augsburg: "Augsburg ist eine der ältesten Städte Deutschlands und das wirtschaftliche Herz Bayerisch-Schwabens — als drittgrößte Stadt Bayerns mit starker Industrie (MAN, KUKA), Universität Augsburg, wachsender Kreativszene und hervorragender Lage zwischen München und Stuttgart bietet Augsburg Selbstständigen beste Voraussetzungen.",
    bayreuth: "Bayreuth ist weltbekannt durch die Wagner-Festspiele und ein wichtiges Kulturzentrum Oberfrankens — mit Universität Bayreuth, einem aktiven Mittelstand, treuer lokaler Kundschaft und einer Bevölkerung, die Qualität und Expertise schätzt, bietet Bayreuth spezialisierten Selbstständigen ein dankbares Marktumfeld.",
    bamberg: "Bamberg ist UNESCO-Weltkulturerbe und eine der schönsten Städte Deutschlands — als Universitätsstadt (Otto-Friedrich-Universität) mit hoher Lebensqualität, starker Tourismuswirtschaft, loyaler lokaler Gemeinschaft und einem gut vernetzten Mittelstand bietet Bamberg Selbstständigen einen stabilen, qualitätsbewussten Markt.",
    kassel: "Kassel ist die nördlichste Großstadt Hessens und bekannt durch die documenta, eine der bedeutendsten Kunstausstellungen der Welt — mit Universität Kassel, starker Industrie (Volkswagen-Werk), wachsender Kreativszene und einer gut vernetzten regionalen Wirtschaft bietet Kassel Selbstständigen ein vielfältiges Marktumfeld.",
    wiesbaden: "Wiesbaden ist die hessische Landeshauptstadt und eine der wohlhabendsten Städte Deutschlands — als Kurstadt mit internationalem Flair, direkter Nähe zu Frankfurt, hoher Kaufkraft, starkem Dienstleistungssektor und einer gut situierten Bevölkerung bietet Wiesbaden Selbstständigen erstklassige Rahmenbedingungen.",
    darmstadt: "Darmstadt ist die Wissenschaftsstadt Hessens — als Heimat von Technischer Universität Darmstadt, ESA/ESOC, GSI Helmholtzzentrum und zahlreichen Hochtechnologieunternehmen, mit einer gut ausgebildeten, technikaffinen Bevölkerung und hoher Kaufkraft bietet Darmstadt Selbstständigen Zugang zu einem anspruchsvollen, innovationsoffenen Markt.",
    marburg: "Marburg ist eine klassische Universitätsstadt an der Lahn — mit Philipps-Universität Marburg (gegründet 1527), lebhafter Studentenszene, wachsendem Dienstleistungssektor und einer akademisch geprägten Bevölkerung bietet Marburg Selbstständigen einen intellektuell neugierigen, qualitätsbewussten Markt.",
    giessen: "Gießen ist eine dynamische Universitätsstadt in Mittelhessen — mit Justus-Liebig-Universität, einer der größten Universitäten Hessens, starker Studierendenpräsenz, wachsendem Dienstleistungssektor und guter Verkehrslage zwischen Frankfurt und Kassel bietet Gießen Selbstständigen ein vielfältiges Kundenpotenzial.",
    fulda: "Fulda ist das Zentrum der Region Osthessen und ein wichtiger Knotenpunkt zwischen Frankfurt, Kassel und Erfurt — als Bischofsstadt mit Barockarchitektur, starkem Einzelhandel, wachsendem Dienstleistungssektor und einer loyalen regionalen Kundschaft bietet Fulda Selbstständigen einen überschaubaren, aber stabilen Markt.",
    offenbach: "Offenbach am Main liegt direkt an der Grenze zu Frankfurt und ist trotz seiner Nähe zur Finanzmetropole ein eigenständiger Wirtschaftsstandort — als Design- und Kreativstadt mit der renommierten Hochschule für Gestaltung, wachsender Startup-Szene und direktem U-Bahn-Anschluss nach Frankfurt bietet Offenbach Selbstständigen einzigartige Chancen.",
    konstanz: "Konstanz ist die südlichste Großstadt Deutschlands und liegt direkt am Bodensee — als Grenzstadt zur Schweiz mit Universität Konstanz, hoher Lebensqualität, internationalem Flair und einer gut situierten, reiseaffinen Bevölkerung bietet Konstanz Selbstständigen Zugang zu einem kaufkräftigen, weltoffenen Markt.",
    reutlingen: "Reutlingen ist eine wichtige Wirtschaftsstadt am Rand der Schwäbischen Alb, direkt südlich von Stuttgart — mit starker mittelständischer Industrie, Hochschule Reutlingen, guter Anbindung an die Metropolregion Stuttgart und einer unternehmerisch denkenden Bevölkerung bietet Reutlingen Selbstständigen solide Wachstumsbedingungen.",
    ludwigsburg: "Ludwigsburg ist die Residenzstadt nördlich von Stuttgart und ein aufstrebender Wirtschaftsstandort in der Region — mit Filmakademie Baden-Württemberg, starkem Mittelstand, hoher Kaufkraft, wachsender Kreativwirtschaft und direkter S-Bahn-Anbindung nach Stuttgart bietet Ludwigsburg Selbstständigen ein attraktives Marktumfeld.",
    esslingen: "Esslingen am Neckar ist eine der ältesten Städte Baden-Württembergs und direkt an Stuttgart angrenzend — als traditionsreicher Industriestandort (ESGE, Festo) mit hoher Kaufkraft, gut ausgebildeter Bevölkerung, starkem Mittelstand und optimaler S-Bahn-Verbindung in die Stuttgarter Innenstadt bietet Esslingen Selbstständigen exzellente Bedingungen.",
    sindelfingen: "Sindelfingen ist untrennbar mit Mercedes-Benz verbunden und eines der wirtschaftsstärksten Mittelzentren Baden-Württembergs — mit dem größten Mercedes-Benz-Werk Deutschlands, sehr hoher Kaufkraft, gut ausgebildeten Fachkräften und direkter Nähe zu Stuttgart und Böblingen bietet Sindelfingen Selbstständigen Zugang zu einer besonders kaufkräftigen Zielgruppe.",
  };
