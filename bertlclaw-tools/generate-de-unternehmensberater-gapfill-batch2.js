...
const cities = [
  {
    ...
    state: 'Sachsen',
    locale: 'de_DE',
    eyebrow: '📍 Unternehmensberater in Chemnitz',
    cityFlavor: 'Chemnitz entwickelt sich als Industrie-, Technologie- und Kulturstandort sichtbar weiter. Zwischen Maschinenbau, Mittelstand und neuen Transformationsprojekten suchen Unternehmen nach externer Beratung, die nicht nur Konzepte liefert, sondern Klarheit, Struktur und Umsetzung greifbar macht.',
    localBlurb: 'Für Beratungsangebote rund um Transformation, Mittelstand und Prozessklarheit in Sachsen.'
  },
  {
    slug: 'cottbus',
    label: 'Cottbus',
    state: 'Brandenburg',
    locale: 'de_DE',
    eyebrow: '📍 Unternehmensberater in Cottbus',
    cityFlavor: 'Cottbus steht wirtschaftlich für Strukturwandel, Energie-Themen und regionale Weiterentwicklung. Gerade in solchen Märkten brauchen Unternehmensberater eine Seite, die Vertrauen aufbaut und Leistungen verständlich macht — statt nur abstrakt von Beratung zu sprechen.',
    localBlurb: 'Für Beratungsangebote zu Wandel, Organisation und wirtschaftlicher Neuausrichtung in Brandenburg.'
  },
  {
    slug: 'duisburg',
    label: 'Duisburg',
    ...
    locale: 'de_DE',
    eyebrow: '📍 Unternehmensberater in Duisburg',
    cityFlavor: 'Duisburg verbindet Logistik, Industrie, Hafenwirtschaft und den breiten Mittelstand des Ruhrgebiets. Für Unternehmensberater ist das ein Markt mit echter Nachfrage — aber auch mit vielen austauschbaren Anbieterprofilen. Eine fokussierte Landingpage schafft hier den nötigen Unterschied.',
    localBlurb: 'Für Beratungsangebote im Ruhrgebiet mit Fokus auf Logistik, Industrie und Mittelstand.'
  },
  {
    slug: 'erfurt',
    label: 'Erfurt',
    state: 'Thüringen',
    locale: 'de_DE',
    eyebrow: '📍 Unternehmensberater in Erfurt',
    cityFlavor: 'Erfurt ist Verwaltungs-, Bildungs- und Wirtschaftszentrum Thüringens. Zwischen öffentlichen Institutionen, regionalem Mittelstand und wachsenden Dienstleistungsstrukturen brauchen Unternehmensberater eine Online-Präsenz, die Seriösität und konkreten Nutzen gleichzeitig vermittelt.',
    localBlurb: 'Für Beratungsangebote in Thüringen mit klarer Positionierung für Organisation und Wachstum.'
  },
  {
    slug: 'flensburg',
    label: 'Flensburg',
    ...
    locale: 'de_DE',
    eyebrow: '📍 Unternehmensberater in Flensburg',
    cityFlavor: 'Flensburg ist Grenzstadt, Hochschulstandort und regionales Zentrum im Norden. Für Unternehmensberater mit Fokus auf Mittelstand, Dienstleistung oder grenznahe Wirtschaftskontexte lohnt sich eine lokale Angebotsseite besonders, weil sie Spezialisierung sofort sichtbar macht.',
    localBlurb: 'Für Beratungsangebote im Norden mit Mittelstands-, Dienstleistungs- und Grenzmarkt-Fokus.'
  }
];
...
function updateLandingpagesIndex() {
  ...
  let html = fs.readFileSync(file, 'utf8');
  if (html.includes('DE Gap-Fill-Cluster: Unternehmensberater Batch 2')) return false;
  const anchor = '</main>';
  const section = `<section class="section"><div class="card"><h2>DE Gap-Fill-Cluster: Unternehmensberater Batch 2</h2><p>Der nächste systematische Unternehmensberater-Batch schließt fünf weitere Lücken im bereits ausgebauten deutschen B2B-Städteset. Ergänzt wurden Städte, in denen die Companion-Seite für <strong>Unternehmensberater</strong> bislang noch fehlte, obwohl verwandte B2B-Profile schon vorhanden waren.</p><div class="grid-3"><article class="card"><h3><a href="landingpage-chemnitz-unternehmensberater.html">Unternehmensberater in Chemnitz</a></h3><p>Für Beratungsangebote rund um Transformation, Mittelstand und Prozessklarheit in Sachsen.</p></article><article class="card"><h3><a href="landingpage-cottbus-unternehmensberater.html">Unternehmensberater in Cottbus</a></h3><p>Für Wandel, Organisation und wirtschaftliche Neuausrichtung im regionalen Strukturwandel.</p></article><article class="card"><h3><a href="landingpage-duisburg-unternehmensberater.html">Unternehmensberater in Duisburg</a></h3><p>Für Consulting im Ruhrgebiet mit Fokus auf Logistik, Industrie und Mittelstand.</p></article><article class="card"><h3><a href="landingpage-erfurt-unternehmensberater.html">Unternehmensberater in Erfurt</a></h3><p>Für Beratungsseiten in Thüringen mit klarer Positionierung für Organisation und Wachstum.</p></article><article class="card"><h3><a href="landingpage-flensburg-unternehmensberater.html">Unternehmensberater in Flensburg</a></h3><p>Für Unternehmensberatung im Norden mit Mittelstands-, Dienstleistungs- und Grenzmarkt-Fokus.</p></article></div></div></section>`;
