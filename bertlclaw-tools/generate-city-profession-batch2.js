#!/usr/bin/env node
/**
 * generate-city-profession-batch2.js
 * Generates city×profession landing pages for additional AT and DE cities.
 * AT: 8 new cities × 20 professions = 160 pages
 * DE: 12 new cities × 20 professions = 240 pages
 * Total: 400 pages (skips already existing files)
 */
...
const newCities = [
  ...
  {city: "Amstetten", slug: "amstetten", country: "AT", region: "Niederösterreich", locale: "de_AT"},
  {city: "Mödling", slug: "moedling", country: "AT", region: "Niederösterreich", locale: "de_AT"},
  {city: "Klosterneuburg", slug: "klosterneuburg", country: "AT", region: "Niederösterreich", locale: "de_AT"},
  {city: "Baden bei Wien", slug: "baden-wien", country: "AT", region: "Niederösterreich", locale: "de_AT"},
  {city: "Hallein", slug: "hallein", country: "AT", region: "Salzburg", locale: "de_AT"},
  {city: "Kufstein", slug: "kufstein", country: "AT", region: "Tirol", locale: "de_AT"},
  {city: "Braunau", slug: "braunau", country: "AT", region: "Oberösterreich", locale: "de_AT"},
  {city: "Stockerau", slug: "stockerau", country: "AT", region: "Niederösterreich", locale: "de_AT"},
  // More German cities
  {city: "Heidelberg", slug: "heidelberg", country: "DE", region: "Baden-Württemberg", locale: "de_DE"},
  {city: "Tübingen", slug: "tuebingen", country: "DE", region: "Baden-Württemberg", locale: "de_DE"},
  {city: "Bayreuth", slug: "bayreuth", country: "DE", region: "Bayern", locale: "de_DE"},
  {city: "Bamberg", slug: "bamberg", country: "DE", region: "Bayern", locale: "de_DE"},
  {city: "Marburg", slug: "marburg", country: "DE", region: "Hessen", locale: "de_DE"},
  {city: "Fulda", slug: "fulda", country: "DE", region: "Hessen", locale: "de_DE"},
  {city: "Lüneburg", slug: "lueneburg", country: "DE", region: "Niedersachsen", locale: "de_DE"},
  {city: "Jena", slug: "jena", country: "DE", region: "Thüringen", locale: "de_DE"},
  {city: "Trier", slug: "trier", country: "DE", region: "Rheinland-Pfalz", locale: "de_DE"},
  {city: "Friedrichshafen", slug: "friedrichshafen", country: "DE", region: "Baden-Württemberg", locale: "de_DE"},
  {city: "Gießen", slug: "giessen", country: "DE", region: "Hessen", locale: "de_DE"},
  {city: "Pforzheim", slug: "pforzheim", country: "DE", region: "Baden-Württemberg", locale: "de_DE"},
];
...
function getCityFlavor(city) {
  const flavors = {
    ...
    braunau: "Braunau am Inn ist das wirtschaftliche Zentrum des gleichnamigen Bezirks in Oberösterreich — mit solider Industrie- und Handwerksbasis und wachsender Dienstleistungsnachfrage.",
    stockerau: "Stockerau im Weinviertel ist ein wichtiges Regionalzentrum nördlich von Wien — mit einer aktiven Wirtschaftsgemeinschaft und wachsender Bedeutung als Pendlerstadt.",
    heidelberg: "Heidelberg mit seiner renommierten Universität und internationalem Flair ist ein besonders attraktiver Markt für wissensintensive Selbstständige in Baden-Württemberg.",
    tuebingen: "Tübingen ist eine der bedeutendsten Universitätsstädte Deutschlands — der Mix aus akademischem Umfeld, internationaler Atmosphäre und starker lokaler Wirtschaft macht die Stadt besonders attraktiv für Selbstständige.",
    bayreuth: "Bayreuth, bekannt durch die Festspiele und die Universität, ist ein kulturell und wirtschaftlich lebhaftes Zentrum in Oberfranken — mit einem aufgeschlossenen Markt für qualifizierte Selbstständige.",
    bamberg: "Bamberg als UNESCO-Welterbestadt in Oberfranken verbindet Tradition mit einer aktiven Wirtschafts- und Hochschulszene — ein solider, gut vernetzter Markt für Selbstständige.",
    marburg: "Marburg an der Lahn ist eine klassische Universitätsstadt in Hessen — geprägt von akademischer Kultur und einer lebhaften, vielfältigen Dienstleistungswirtschaft.",
    fulda: "Fulda als Zentrum der Rhön-Region in Hessen ist ein wichtiger Wirtschaftsstandort mit starker mittelständischer Prägung und wachsender Dienstleistungsnachfrage.",
    lueneburg: "Lüneburg in Niedersachsen verbindet historisches Stadtbild mit einer modernen Wirtschaft — die Leuphana Universität und die Nähe zu Hamburg machen die Stadt zu einem attraktiven Standort für Selbstständige.",
    ...
    trier: "Trier als älteste Stadt Deutschlands und Zentrum der Moselregion verbindet Geschichte mit einer soliden regionalen Wirtschaft — und einer treuen, gut vernetzten Unternehmensgemeinschaft.",
    friedrichshafen: "Friedrichshafen am Bodensee ist ein globaler Industriestandort mit Zeppelin, ZF und Rolls-Royce als Ankerbetriebe — und einem starken, kaufkräftigen Markt für selbstständige Dienstleister.",
    giessen: "Gießen mit seiner Justus-Liebig-Universität ist das wirtschaftliche und akademische Zentrum Mittelhessens — eine lebhafte Stadt mit wachsender Nachfrage nach professionellen Dienstleistungen.",
    pforzheim: "Pforzheim, die Goldstadt am Eingang des Schwarzwalds, verbindet Handwerkstradition mit moderner Wirtschaft — ein solider Markt für positionierte Selbstständige in Baden-Württemberg.",
  };
  return flavors[city.slug] || `${city.city} in ${city.region} ist ein wichtiger regionaler Wirtschaftsstandort im DACH-Raum mit wachsender Nachfrage nach professionellen Dienstleistungen.`;
}

function generateContent(city, prof) {
  const isAT = city.country === 'AT';
  const regionTerm = isAT ? 'Bundesland' : 'Bundesland';
  const countryContext = isAT ? 'in Österreich' : 'in Deutschland';
...
function generatePage(city, prof) {
  ...
  const description = `${prof.label} in ${city.city} (${city.region}): Professionelle Landingpage und Website-Texte von BertlClaw.`;
...
<body>
  ...
  <header class="hero wrap">
    <div class="hero-inner">
      ...
      <p class="lead">Du bist als ${prof.keyword} in ${city.city} tätig und willst online gefunden werden? BertlClaw erstellt professionelle Landingpages für ${prof.label} in ${city.city} (${city.region}) — klar positioniert, überzeugend getextet und in wenigen Tagen live.</p>
      <div class="cta">
  ...
  <footer class="footer wrap">
    ...
    BertlClaw · Landingpage für ${prof.label} in ${city.city} · Für ${prof.keyword} in ${city.region}
  </footer>
</body>
</html>`;
}
