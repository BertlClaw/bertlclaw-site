#!/usr/bin/env node
/**
 * generate-de-ost-nord.js
 * Generates city×profession landing pages for Ostdeutschland + Norddeutschland.
 * Cities: 20 (Thüringen, Sachsen-Anhalt, Brandenburg, Sachsen + Schleswig-Holstein, Mecklenburg-Vorpommern, Niedersachsen)
 * Professions: 30
...
const cities = [
  ...
  {city: "Jena", slug: "jena", state: "Thüringen", locale: "de_DE"},
  {city: "Weimar", slug: "weimar", state: "Thüringen", locale: "de_DE"},
  {city: "Gera", slug: "gera", state: "Thüringen", locale: "de_DE"},
  {city: "Magdeburg", slug: "magdeburg", state: "Sachsen-Anhalt", locale: "de_DE"},
  {city: "Halle", slug: "halle", state: "Sachsen-Anhalt", locale: "de_DE"},
  ...
  // Norddeutschland
  {city: "Kiel", slug: "kiel", state: "Schleswig-Holstein", locale: "de_DE"},
  {city: "Lübeck", slug: "luebeck", state: "Schleswig-Holstein", locale: "de_DE"},
  {city: "Flensburg", slug: "flensburg", state: "Schleswig-Holstein", locale: "de_DE"},
  {city: "Rostock", slug: "rostock", state: "Mecklenburg-Vorpommern", locale: "de_DE"},
  {city: "Schwerin", slug: "schwerin", state: "Mecklenburg-Vorpommern", locale: "de_DE"},
  {city: "Greifswald", slug: "greifswald", state: "Mecklenburg-Vorpommern", locale: "de_DE"},
...
function getCityFlavor(city) {
  const flavors = {
    erfurt: "Erfurt ist die Landeshauptstadt Thüringens und eines der wirtschaftlichen Zentren Ostdeutschlands — mit Universität Erfurt, dem Erfurter Kreuz als bedeutendem Gewerbestandort, wachsender Startup-Szene und Lage im Herzen Deutschlands bietet Erfurt Selbstständigen Zugang zu einem dynamischen, gut vernetzten Markt in der Mitte der Republik.",
    jena: "Jena ist das Innovationszentrum Thüringens — als Universitätsstadt mit renommierter Friedrich-Schiller-Universität, starker Technologiebranche (Jenoptik, Zeiss), lebhafter Gründerkultur und dichtem Netzwerk aus Forschung und Wirtschaft bietet Jena Selbstständigen ein wissensaffines, innovationsoffenes Umfeld mit hoher Nachfrage nach professionellen Dienstleistungen.",
    weimar: "Weimar ist eine der kulturell bedeutendsten Städte Deutschlands — als UNESCO-Welterbestadt, Geburtsort des Bauhauses und Stätte von Goethe und Schiller zieht Weimar ein bildungsbürgerliches, kulturaffines Publikum an, das Qualität und Expertise schätzt und bereit ist, in professionelle Dienstleistungen zu investieren.",
    gera: "Gera ist die drittgrößte Stadt Thüringens und ein wichtiges regionales Wirtschaftszentrum im Osten des Freistaats — mit solider Mittelstandsstruktur, wachsendem Dienstleistungssektor und einer Bevölkerung, die im Strukturwandel zunehmend auf professionelle Unterstützung setzt, bietet Gera Selbstständigen einen stabilen lokalen Markt mit Wachstumspotenzial.",
    magdeburg: "Magdeburg ist die Landeshauptstadt Sachsen-Anhalts und ein wichtiger Industriestandort an der Elbe — mit Otto-von-Guericke-Universität, bedeutenden Unternehmen (Siemens Energy, Stadtwerke), stark wachsender Wirtschaft und strategischer Lage zwischen Hannover und Berlin bietet Magdeburg Selbstständigen Zugang zu einem robusten regionalen Markt.",
    halle: "Halle (Saale) ist die größte Stadt Sachsen-Anhalts und ein bedeutendes Wirtschafts- und Wissenschaftszentrum — mit Martin-Luther-Universität Halle-Wittenberg, der Chemiebranche als regionalem Anker, wachsender Kreativwirtschaft und direkter Anbindung an Leipzig bietet Halle Selbstständigen einen vielfältigen Markt mit universitärem und wirtschaftlichem Potenzial.",
    potsdam: "Potsdam ist die Landeshauptstadt Brandenburgs und eine der wohlhabendsten Städte Ostdeutschlands — als UNESCO-Welterbestadt, Regierungssitz, Heimat des HPI und direkter Nachbar Berlins bietet Potsdam Selbstständigen Zugang zu einer kaufkräftigen, gut ausgebildeten Bevölkerung mit hoher Affinität zu innovativen und professionellen Dienstleistungen.",
    cottbus: "Cottbus ist das wirtschaftliche Zentrum der Lausitz und steht vor einem tiefgreifenden Strukturwandel — von der Kohlestadt zur Energie-Innovationsregion. Mit BTU Cottbus-Senftenberg, wachsenden Förderprogrammen, dem Lausitz Science Park und einer Region im Aufbruch bietet Cottbus Selbstständigen ein Umfeld mit einzigartigen Chancen im Bereich Transformation und Innovation.",
    leipzig: "Leipzig ist eine der am schnellsten wachsenden Städte Deutschlands — mit Universität Leipzig, starker Kreativwirtschaft, boomender Startup-Szene, hoher Lebensqualität und direkter Verbindung zu Berlin und den anderen Wirtschaftszentren macht Leipzig Selbstständigen das Arbeiten in einem dynamischen, urbanen Umfeld besonders attraktiv.",
    dresden: "Dresden ist das wirtschaftliche Herz Sachsens und nach München die stärkste Hightech-Region Deutschlands — als Heimat von Globalfoundries, Infineon, Bosch und einer exzellenten Hochschullandschaft (TU Dresden) bietet Dresden Selbstständigen Zugang zu einer technologieaffinen, gut ausgebildeten und kaufkräftigen Bevölkerung.",
    chemnitz: "Chemnitz ist das industrielle Rückgrat Sachsens und hat sich vom Traditionsstandort zur modernen Technologiestadt entwickelt — mit TU Chemnitz, starkem Maschinenbau-Cluster, Kulturhauptstadt Europas 2025 und wachsendem Dienstleistungssektor bietet Chemnitz Selbstständigen ein solides wirtschaftliches Umfeld mit Aufbruchsstimmung.",
    zwickau: "Zwickau ist das Automobilzentrum Sachsens — als Heimat von VW Sachsen und mit starker Automobil-Zulieferindustrie, Westsächsischer Hochschule Zwickau und einem wachsenden Mittelstand bietet Zwickau Selbstständigen Zugang zu einem Markt, der industrielle Stärke mit wachsender Dienstleistungsnachfrage verbindet.",
    kiel: "Kiel ist die Landeshauptstadt Schleswig-Holsteins und ein bedeutendes Hafenstädtisches Wirtschaftszentrum an der Ostsee — mit Christian-Albrechts-Universität, starker maritimen Industrie, dem weltbekannten Kieler Woche-Netzwerk und einer gut ausgebildeten Bevölkerung bietet Kiel Selbstständigen einen stabilen norddeutschen Markt mit internationalem Flair.",
    luebeck: "Lübeck ist die Königin der Hanse und eine der kulturell reichsten Städte Norddeutschlands — als UNESCO-Welterbestadt, Medizintechnik-Standort (mit Universität zu Lübeck), Geburtsstadt von Thomas Mann und Tor zur Ostseeküste bietet Lübeck Selbstständigen Zugang zu einem gehobenen, bildungsaffinen Publikum in einer der schönsten Altstädte Deutschlands.",
    flensburg: "Flensburg ist die nördlichste Großstadt Deutschlands und ein wirtschaftlich lebhaftes Zentrum direkt an der dänischen Grenze — mit einzigartiger zweisprachig-kultureller Atmosphäre, wachsendem Dienstleistungssektor, Fachhochschule Flensburg und enger Vernetzung mit dem dänischen Markt bietet Flensburg Selbstständigen ein besonderes, grenzübergreifendes Arbeitsumfeld.",
    rostock: "Rostock ist die größte Stadt Mecklenburg-Vorpommerns und ein bedeutendes Hafenstädtisches Wirtschaftszentrum an der Ostsee — mit Universität Rostock, starker Schiffbau- und Meerestechnikbranche, wachsendem Tourismus- und Dienstleistungssektor und direkter Fährverbindung nach Skandinavien bietet Rostock Selbstständigen einen dynamischen norddeutschen Markt.",
    schwerin: "Schwerin ist die Landeshauptstadt Mecklenburg-Vorpommerns und eine der malerischsten Städte Norddeutschlands — als Regierungssitz, Kulturzentrum mit dem berühmten Schweriner Schloss und wachsendem Dienstleistungssektor bietet Schwerin Selbstständigen Zugang zu einem überschaubaren, aber qualitätsbewussten Markt mit Behörden, Unternehmen und gutem regionalem Netzwerk.",
    greifswald: "Greifswald ist eine der ältesten Universitätsstädte Deutschlands und das Wissenschaftszentrum Vorpommerns — mit Ernst-Moritz-Arndt-Universität, Max-Planck-Institut für Plasmaphysik, starker Forschungskultur und einer akademisch geprägten Bevölkerung bietet Greifswald Selbstständigen ein bildungsaffines, innovationsoffenes Umfeld an der Ostseeküste.",
    oldenburg: "Oldenburg ist das wirtschaftliche Zentrum Nordwestniedersachsens und eine der am stärksten wachsenden Städte der Region — mit Carl von Ossietzky Universität, starker Medizintechnik- und Ernährungswirtschaft, lebhafter Startup-Szene und direkter Anbindung an Bremen und die Küste bietet Oldenburg Selbstständigen einen modernen, gut vernetzten Markt.",
    osnabrueck: "Osnabrück ist die Friedensstadt und ein bedeutendes Wirtschaftszentrum im Osnabrücker Land — als Logistik-Hub, Heimat großer Unternehmen (Wissoll, Nobilia), mit Universität Osnabrück und Hochschule Osnabrück, starkem Mittelstand und kaufkräftiger Bevölkerung bietet Osnabrück Selbstständigen einen robusten, unternehmerisch geprägten Markt in Niedersachsen.",
  };
  return flavors[city.slug] || `${city.city} in ${city.state} ist ein wichtiger regionaler Wirtschaftsstandort mit wachsender Nachfrage nach professionellen Dienstleistungen.`;
}
