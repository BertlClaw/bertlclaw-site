#!/usr/bin/env node
/**
 * generate-de-batch7.js
 * Generates city×profession landing pages for German cities (batch 7).
 * Cities: 20 (NRW Großstädte + Ergänzung, Hessen, Hamburg, Berlin, Bayern, Baden-Württemberg)
 * Professions: 25
...
const cities = [
  ...
  {city: "Essen", slug: "essen", state: "Nordrhein-Westfalen", locale: "de_DE"},
  {city: "Düsseldorf", slug: "duesseldorf", state: "Nordrhein-Westfalen", locale: "de_DE"},
  {city: "Köln", slug: "koeln", state: "Nordrhein-Westfalen", locale: "de_DE"},
  ...
  {city: "Offenbach", slug: "offenbach", state: "Hessen", locale: "de_DE"},
];
...
function getCityFlavor(city) {
  const flavors = {
    duisburg: "Duisburg ist der größte Binnenhafen der Welt und das Tor zum Ruhrgebiet — als Logistikzentrum mit intensivem Strukturwandel, wachsender Kreativszene und einer Bevölkerung, die professionelle Dienstleistungen in einem überschaubaren Wettbewerbsumfeld sucht, bietet die Stadt Selbstständigen attraktive Chancen.",
    essen: "Essen ist die Metropole des Ruhrgebiets und war Kulturhauptstadt Europas 2010 — mit Universität Duisburg-Essen, dem Konzern-Hauptsitz von RWE und thyssenkrupp, einer lebhaften Gastronomie- und Kulturszene sowie einer gut ausgebildeten Bevölkerung bietet Essen professionellen Selbstständigen ein starkes Umfeld.",
    duesseldorf: "Düsseldorf ist die Landeshauptstadt von Nordrhein-Westfalen und eines der wichtigsten Wirtschafts- und Modezentren Deutschlands — als Sitz vieler DAX-Konzerne und internationaler Firmen, mit hervorragender Infrastruktur, einer der bedeutendsten Messestädte (MESSE DÜSSELDORF) und hoher Kaufkraft bietet die Stadt erstklassige Bedingungen für positionierte Selbstständige.",
    koeln: "Köln ist die viertgrößte Stadt Deutschlands und ein Medien-, Kultur- und Wirtschaftszentrum am Rhein — als Heimat von WDR, RTL, Deutschlandradio und zahlreichen Kreativagenturen, mit Universität zu Köln, hoher Lebensqualität und einer offenen, dynamischen Bevölkerung bietet Köln Selbstständigen ein besonders attraktives Umfeld.",
    hamburg: "Hamburg ist Deutschlands zweitgrößte Stadt und wichtigster Hafen — als Medienmetropole (Spiegel, Zeit, NDR), Handelszentrum, Startup-Hub und Tor zur Welt verbindet Hamburg internationales Flair mit norddeutscher Bodenständigkeit und bietet Selbstständigen einen der kaufkräftigsten Märkte Deutschlands.",
    berlin: "Berlin ist die Bundeshauptstadt und Deutschlands größte Stadt — mit einem der aktivsten Startup-Ökosysteme Europas, rund 200.000 Selbstständigen, einer diversen und gut ausgebildeten Bevölkerung sowie einer Kultur der Eigenverantwortung und Innovation ist Berlin der ideale Markt für positionierte Selbstständige jeder Branche.",
    muenchen: "München ist Deutschlands drittgrößte Stadt und wirtschaftlich eine der stärksten Regionen Europas — als Heimat von BMW, Siemens, Allianz, MAN und einer der dichtesten Startup-Szenen Deutschlands bietet München mit hoher Kaufkraft, exzellenter Infrastruktur und einer gut ausgebildeten Bevölkerung ideale Voraussetzungen für professionelle Selbstständige.",
    frankfurt: "Frankfurt am Main ist das Finanz- und Wirtschaftszentrum Deutschlands — als Sitz der Europäischen Zentralbank, Deutschen Bundesbank, Deutschen Börse und zahlreicher internationaler Banken und Konzerne, mit dem größten Flughafen Deutschlands und einer der internationalsten Bevölkerungen, bietet Frankfurt Selbstständigen Zugang zu einer kaufkräftigen, anspruchsvollen Zielgruppe.",
    stuttgart: "Stuttgart ist das Herzstück der deutschen Industrie- und Ingenieurskultur — als Heimat von Mercedes-Benz, Porsche, Bosch und Trumpf mit einem der niedrigsten Arbeitslosenquoten Deutschlands, hoher Kaufkraft und einer technikaffinen, gut vernetzten Bevölkerung bietet Stuttgart professionellen Selbstständigen ein hervorragendes Marktumfeld.",
    leverkusen: "Leverkusen ist bekannt als Heimat von Bayer AG und TSV Bayer 04 Leverkusen — als Industriestandort mit starker internationaler Vernetzung, hoher Kaufkraft und direkter Nähe zu Köln und Düsseldorf bietet die Stadt Selbstständigen eine solide wirtschaftliche Basis in einem weniger gesättigten lokalen Markt.",
    solingen: "Solingen ist die Klingenstadt und weltweit bekannt für Messerschmiede-Tradition — als Handwerksstadt im Bergischen Land mit gut vernetztem Mittelstand, hoher Handwerkskultur und einer Bevölkerung, die Qualität und Expertise schätzt, bietet Solingen spezialisierten Selbstständigen ein treues Kundensegment.",
    remscheid: "Remscheid ist die dritte Stadt im Bergischen Städtedreieck neben Wuppertal und Solingen — mit einer langen Industrietradition (Werkzeugherstellung), einem aktiven Mittelstand und einer Bevölkerung, die lokale Expertise schätzt, bietet Remscheid Selbstständigen einen überschaubaren, loyalen Markt.",
    bottrop: "Bottrop ist eine mittelgroße Stadt im nördlichen Ruhrgebiet mit starkem Gemeinschaftssinn — im Rahmen des Strukturwandels entwickelt sich die Stadt zunehmend hin zu Dienstleistung und Kreativwirtschaft. Die überschaubare Größe bietet Selbstständigen den Vorteil, sich schnell lokal bekannt zu machen und eine treue Kundenbasis aufzubauen.",
    neuss: "Neuss liegt direkt gegenüber von Düsseldorf am Rhein und profitiert von der wirtschaftlichen Strahlkraft der Landeshauptstadt — mit eigenem Hafen, wachsendem Dienstleistungssektor und einer gut situierten Bevölkerung bietet Neuss Selbstständigen eine attraktive Alternative zu den teuren Düsseldorfer Innenstadtlagen.",
    moenchengladbach: "Mönchengladbach ist die größte Stadt im niederrheinischen Raum und ein bedeutender Textil- und Handelssstandort — mit Hochschule Niederrhein, wachsendem Dienstleistungssektor und direkter Nähe zu Düsseldorf und den Niederlanden bietet die Stadt Selbstständigen einen gut vernetzten regionalen Markt.",
    krefeld: "Krefeld ist die Seidenstadt am Niederrhein — als traditioneller Textilstandort mit wachsender Kreativwirtschaft, gutem Hochschulanschluss und direkt an der niederrheinischen Metropolachse gelegen bietet Krefeld Selbstständigen einen Markt mit echter lokaler Identität und loyaler Kundschaft.",
    muelheim: "Mülheim an der Ruhr ist eine der wohlhabendsten Städte des Ruhrgebiets — mit Tengelmann-Gruppe und weiteren mittelständischen Unternehmen, einer gut situierten Bevölkerung und direkter Nähe zu Essen und Duisburg bietet Mülheim Selbstständigen Zugang zu einer kaufkräftigen, qualitätsbewussten Zielgruppe.",
    ratingen: "Ratingen liegt direkt an der Grenze zu Düsseldorf und gilt als eine der wirtschaftsstärksten Städte NRWs — mit zahlreichen Unternehmenshauptsitzen, hoher Kaufkraft, gut ausgebildeter Bevölkerung und hervorragender Verkehrsanbindung bietet Ratingen Selbstständigen ein ausgezeichnetes Wachstumsumfeld.",
    "bergisch-gladbach": "Bergisch Gladbach ist das Zentrum des Bergischen Landes östlich von Köln — als Verwaltungssitz des Rheinisch-Bergischen Kreises, mit einer gut vernetzten Unternehmerschaft, hoher Lebensqualität und direkter S-Bahn-Verbindung nach Köln bietet die Stadt Selbstständigen ein attraktives Marktumfeld mit urbanem Anschluss.",
    offenbach: "Offenbach am Main liegt direkt an der Grenze zu Frankfurt und ist trotz seiner Nähe zur Finanzmetropole ein eigenständiger Wirtschaftsstandort — als Design- und Lederwarenstadt mit der renommierten Hochschule für Gestaltung, wachsender Kreativszene und direktem U-Bahn-Anschluss nach Frankfurt bietet Offenbach Selbstständigen einzigartige Chancen.",
  };
