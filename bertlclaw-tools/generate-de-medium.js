#!/usr/bin/env node
/**
 * generate-de-medium.js
 * Generates city×profession landing pages for medium-sized German cities (NRW batch).
 * Cities: 20 (NRW Ruhrgebiet + Bergisches Land)
 * Professions: 30
 * Total: up to 600 pages (skips already existing files)
 */
...
const cities = [
  {city: "Aachen", slug: "aachen", state: "Nordrhein-Westfalen", locale: "de_DE"},
  {city: "Wuppertal", slug: "wuppertal", state: "Nordrhein-Westfalen", locale: "de_DE"},
  {city: "Bielefeld", slug: "bielefeld", state: "Nordrhein-Westfalen", locale: "de_DE"},
  {city: "Bochum", slug: "bochum", state: "Nordrhein-Westfalen", locale: "de_DE"},
  {city: "Gelsenkirchen", slug: "gelsenkirchen", state: "Nordrhein-Westfalen", locale: "de_DE"},
  {city: "Krefeld", slug: "krefeld", state: "Nordrhein-Westfalen", locale: "de_DE"},
  {city: "Oberhausen", slug: "oberhausen", state: "Nordrhein-Westfalen", locale: "de_DE"},
  {city: "Herne", slug: "herne", state: "Nordrhein-Westfalen", locale: "de_DE"},
  {city: "Neuss", slug: "neuss", state: "Nordrhein-Westfalen", locale: "de_DE"},
  {city: "Mönchengladbach", slug: "moenchengladbach", state: "Nordrhein-Westfalen", locale: "de_DE"},
  {city: "Solingen", slug: "solingen", state: "Nordrhein-Westfalen", locale: "de_DE"},
  {city: "Leverkusen", slug: "leverkusen", state: "Nordrhein-Westfalen", locale: "de_DE"},
  {city: "Remscheid", slug: "remscheid", state: "Nordrhein-Westfalen", locale: "de_DE"},
  {city: "Bottrop", slug: "bottrop", state: "Nordrhein-Westfalen", locale: "de_DE"},
  {city: "Bergisch Gladbach", slug: "bergisch-gladbach", state: "Nordrhein-Westfalen", locale: "de_DE"},
  {city: "Ratingen", slug: "ratingen", state: "Nordrhein-Westfalen", locale: "de_DE"},
  {city: "Mülheim an der Ruhr", slug: "muelheim", state: "Nordrhein-Westfalen", locale: "de_DE"},
  {city: "Duisburg", slug: "duisburg", state: "Nordrhein-Westfalen", locale: "de_DE"},
  {city: "Lünen", slug: "luenen", state: "Nordrhein-Westfalen", locale: "de_DE"},
...
const professions = [
  ...
  {slug: "ingenieur", label: "Ingenieure", keyword: "Ingenieur"},
  {slug: "projektmanager", label: "Projektmanager", keyword: "Projektmanager"},
  {slug: "hr-berater", label: "HR-Berater", keyword: "HR-Berater"},
  {slug: "energieberater", label: "Energieberater", keyword: "Energieberater"},
  {slug: "ki-berater", label: "KI-Berater", keyword: "KI-Berater"},
];
...
const professionContent = {
  ...
  ingenieur: {
    intro: "Ingenieure mit eigener Beratung oder Projektarbeit stehen vor einer ungewohnten Aufgabe: die eigene Expertise online sichtbar zu machen — präzise, professionell, überzeugend.",
    detail: "Ob Maschinenbau, Elektrotechnik, Bauingenieurwesen oder Verfahrenstechnik — wer als freiberuflicher Ingenieur tätig ist, braucht eine Landingpage, die technische Tiefe mit klarer Kommunikation verbindet. Auftraggeber wollen sofort verstehen, was du kannst und wofür du stehst.",
    value: "BertlClaw entwickelt Landingpages für Ingenieure und technische Freelancer, die Fachkompetenz verständlich übersetzen, die richtige Zielgruppe ansprechen und Projektanfragen generieren."
  },
  projektmanager: {
    intro: "Projektmanager und PMO-Berater sind in fast jeder Branche gefragt — aber online oft unsichtbar. Eine fokussierte Landingpage ändert das.",
    detail: "Wer einen erfahrenen Projektmanager sucht, schaut heute zuerst online. Die entscheidende Frage: Welche Branchen, welche Methoden, welche Ergebnisse? Wer das klar kommuniziert, gewinnt qualifizierte Anfragen ohne aufwändige Akquise.",
    value: "BertlClaw erstellt Landingpages für Projektmanager und PMO-Berater, die Erfahrung und Methodik klar darstellen, die passenden Auftraggeber ansprechen und den Einstieg in die Zusammenarbeit verkürzen."
  },
  "hr-berater": {
    intro: "HR-Berater und Personalentwickler sind gefragte Experten — aber ihre Expertise ist für Außenstehende oft schwer greifbar. Eine gute Landingpage macht den Unterschied.",
    detail: "Unternehmen, die HR-Beratung suchen, haben konkrete Probleme: Recruiting, Führungskräfteentwicklung, Kulturwandel, Employer Branding. Wer genau diese Themen auf seiner Landingpage adressiert, spricht die richtigen Entscheider an.",
    value: "BertlClaw entwickelt Landingpages für HR-Berater und Personalentwickler, die Beratungsansatz und Wirkung klar kommunizieren, die richtigen Unternehmenskunden ansprechen und Erstgespräche generieren."
  },
  energieberater: {
    intro: "Energieberater sind in Zeiten steigender Energiekosten und wachsender Klimaanforderungen gefragter denn je — aber online oft schwer auffindbar.",
    detail: "Wer einen Energieberater sucht, steht meist vor einer konkreten Entscheidung: Sanierung, Neubau, Fördermittelantrag, Energieausweis. Eine Landingpage, die genau diese Situationen anspricht, sorgt für qualifizierte Anfragen.",
    value: "BertlClaw erstellt Landingpages für Energieberater, die Leistungsangebot und Förderwissen klar darstellen, Vertrauen in einem regulierten Umfeld aufbauen und neue Kunden effizient gewinnen."
  },
  "ki-berater": {
    intro: "KI-Berater und AI-Consultants sind eine der gefragtesten Expertenkategorien der Gegenwart — und wer hier online gut positioniert ist, gewinnt Mandate fast von selbst.",
    detail: "Unternehmen suchen KI-Kompetenz: für Automatisierung, Prozessoptimierung, Prompt Engineering, KI-Strategie. Wer klar kommuniziert, welche Ergebnisse er liefert und für welche Branchen er steht, gewinnt die richtigen Auftraggeber.",
    value: "BertlClaw entwickelt Landingpages für KI-Berater und AI-Consultants, die technische Kompetenz verständlich machen, konkrete Anwendungsfälle zeigen und Anfragen qualifizierter Unternehmen generieren."
  },
};
...
function getCityFlavor(city) {
  const flavors = {
    aachen: "Aachen ist die westlichste Großstadt Deutschlands und ein bedeutendes europäisches Zentrum — als Heimat der RWTH Aachen (eine der renommiertesten technischen Universitäten Europas), mit starker Medizin- und Technologiebranche, Nähe zu Belgien und den Niederlanden sowie einer lebhaften Startup-Szene bietet Aachen Selbstständigen ein innovationsoffenes, gut vernetztes Marktumfeld.",
    wuppertal: "Wuppertal ist bekannt durch seine einzigartige Schwebebahn und liegt im Herzen des Bergischen Landes — mit einer lebhaften Kreativszene, der Bergischen Universität, starkem Mittelstand und einer wachsenden Gründerkultur bietet Wuppertal Selbstständigen ein vielfältiges Klientenpotenzial in einer der charaktervollsten Städte NRWs.",
    bielefeld: "Bielefeld ist das wirtschaftliche Zentrum Ostwestfalen-Lippes — als Stadt mit starker Mittelstandsbasis (Dr. Oetker, Schüco, Gildemeister), Universität Bielefeld, solider Kaufkraft und einer pragmatisch-unternehmerischen Bevölkerung bietet Bielefeld Selbstständigen stabile und verlässliche Rahmenbedingungen.",
    bochum: "Bochum ist das Herz des Ruhrgebiets und hat sich erfolgreich vom Industriestandort zur Wissens- und Kulturstadt gewandelt — mit Ruhr-Universität Bochum (eine der größten Deutschlands), wachsender IT- und Kreativwirtschaft, starker Kulturszene und direkter Anbindung ans Ruhrgebiet bietet Bochum Selbstständigen einen dynamischen und sich wandelnden Markt.",
    gelsenkirchen: "Gelsenkirchen ist eine Stadt im Wandel — der Strukturwandel nach der Kohle- und Stahlzeit hat eine Aufbruchsstimmung erzeugt, die Nachfrage nach professionellen Dienstleistungen wächst, und wer jetzt lokal sichtbar ist, positioniert sich früh in einem sich entwickelnden Markt mit Potenzial.",
    krefeld: "Krefeld ist bekannt als Seidenstadt und ein wichtiger Textil- und Industriestandort am linken Niederrhein — mit gut vernetztem Mittelstand, direkter Nähe zu Düsseldorf, einer stabilen Wirtschaftsstruktur und kaufkräftiger Bevölkerung bietet Krefeld Selbstständigen einen verlässlichen lokalen Markt.",
    oberhausen: "Oberhausen ist eine Ruhrgebietsstadt mit ausgeprägtem Strukturwandel und wachsenden Dienstleistungssektor — bekannt durch das Centro (eines der größten Einkaufszentren Deutschlands) und eine aktive lokale Wirtschaft bietet Oberhausen Selbstständigen Zugang zu einem urban geprägten Klientenumfeld.",
    herne: "Herne ist eine kompakte Ruhrgebietsstadt mit enger Vernetzung in die Metropolregion — direkte Nachbarschaft zu Bochum und Gelsenkirchen, solide lokale Wirtschaft und ein wachsender Dienstleistungsmarkt machen Herne zu einem praktischen Standort für spezialisierte Selbstständige, die die gesamte Region bedienen wollen.",
    neuss: "Neuss liegt direkt gegenüber von Düsseldorf am Rhein und profitiert von der Nähe zur Landeshauptstadt — mit eigenem starken Mittelstand, Hafen als Wirtschaftsmotor, hoher Kaufkraft und direkter Verbindung nach Düsseldorf bietet Neuss Selbstständigen den Zugang zu einer kaufkräftigen, gut vernetzten Region.",
    moenchengladbach: "Mönchengladbach ist die größte Stadt am linken Niederrhein — mit starker Mittelstandswirtschaft, direkter Nähe zu Düsseldorf und Köln, dem Borussia-Park als Kulturanker und einer pragmatisch-unternehmerischen Bevölkerung bietet Mönchengladbach Selbstständigen einen soliden regionalen Markt mit guter Infrastruktur.",
    solingen: "Solingen ist die Klingenstadt und bekannt für Präzision und Handwerkskunst — als Bergische Stadt mit starker Industrietradition, gut vernetztem Mittelstand und einer Bevölkerung, die Qualität und Fachkompetenz schätzt, bietet Solingen Selbstständigen ein dankbares Umfeld für spezialisierte, hochwertige Dienstleistungen.",
    leverkusen: "Leverkusen ist untrennbar mit Bayer verbunden und einer der bedeutendsten Pharma- und Chemiestandorte Deutschlands — mit hoher Kaufkraft, gut ausgebildeter Bevölkerung, direkter Nähe zu Köln und Düsseldorf sowie einem starken Unternehmensumfeld bietet Leverkusen Selbstständigen Zugang zu einer besonders anspruchsvollen Zielgruppe.",
    remscheid: "Remscheid ist eine Bergische Stadt mit starker Werkzeug- und Industrietradition — als kompakter Markt mit gut vernetztem Mittelstand, loyaler lokaler Kundschaft und einer Bevölkerung, die Präzision und Zuverlässigkeit schätzt, bietet Remscheid spezialisierten Selbstständigen ein stabiles Umfeld.",
    bottrop: "Bottrop liegt im nördlichen Ruhrgebiet und hat sich als InnovationCity aktiv für den Strukturwandel positioniert — als überschaubare Stadt mit aktiver Wirtschaftsförderung, wachsendem Dienstleistungssektor und enger Vernetzung ins Ruhrgebiet bietet Bottrop Selbstständigen lokale Sichtbarkeit mit regionaler Reichweite.",
    "bergisch-gladbach": "Bergisch Gladbach ist die Kreisstadt des Rheinisch-Bergischen Kreises und liegt direkt östlich von Köln — mit hoher Kaufkraft, gut ausgebildeter Bevölkerung, starkem Mittelstand und direkter S-Bahn-Anbindung nach Köln bietet Bergisch Gladbach Selbstständigen Zugang zu einem wohlhabenden, dienstleistungsaffinen Markt.",
    ratingen: "Ratingen liegt direkt zwischen Düsseldorf und dem Bergischen Land — als Wohnstadt mit hoher Kaufkraft, starkem Mittelstand, direkter Nähe zu Düsseldorf und einer gut ausgebildeten Bevölkerung bietet Ratingen Selbstständigen einen attraktiven Markt mit urbanem Anschluss.",
    muelheim: "Mülheim an der Ruhr ist eine der wohlhabendsten Städte im Ruhrgebiet — mit einer reichen Industriegeschichte (Tengelmann, Hochtief), hoher Kaufkraft, direkter Nähe zu Essen und Duisburg sowie einem gut vernetzten Mittelstand bietet Mülheim Selbstständigen Zugang zu einer kaufkräftigen, qualitätsbewussten Zielgruppe.",
    duisburg: "Duisburg ist Europas größter Binnenhafen und eine bedeutende Logistik- und Wirtschaftsmetropole am Rhein — mit starker Industriebasis, wachsendem Dienstleistungssektor, Universität Duisburg-Essen und direkter Anbindung an Düsseldorf und das Ruhrgebiet bietet Duisburg Selbstständigen einen vielfältigen, strukturell robusten Markt.",
    luenen: "Lünen liegt an der Lippe nördlich von Dortmund und ist ein wichtiges Mittelzentrum im Kreis Unna — mit gut vernetztem Mittelstand, direkter Nähe zur Metropole Dortmund, solider lokaler Wirtschaft und einer Bevölkerung, die professionelle Dienstleistungen zunehmend online sucht, bietet Lünen Selbstständigen eine attraktive Kombination aus lokalem Markt und regionaler Reichweite.",
    siegen: "Siegen ist das wirtschaftliche Zentrum Südwestfalens und bekannt als Geburtsstadt von Peter Paul Rubens — mit Universität Siegen, starkem Mittelstand (Lorch, Listertalwerk), einer unternehmerisch geprägten Region und hoher Loyalität zur lokalen Dienstleisterschaft bietet Siegen Selbstständigen ein stabiles und dankbares Marktumfeld.",
  };
  return flavors[city.slug] || `${city.city} in ${city.state} ist ein wichtiger regionaler Wirtschaftsstandort in Nordrhein-Westfalen mit wachsender Nachfrage nach professionellen Dienstleistungen.`;
}
