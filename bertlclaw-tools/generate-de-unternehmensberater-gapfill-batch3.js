...
const cities = [
  {
    ...
    locale: 'de_DE',
    eyebrow: '📍 Unternehmensberater in Gelsenkirchen',
    cityFlavor: 'Gelsenkirchen steht für industriellen Wandel, Energiegeschichte und die Herausforderung, wirtschaftliche Erneuerung konkret umzusetzen. Gerade in solchen Märkten brauchen Unternehmensberater eine Seite, die nicht nur Kompetenz behauptet, sondern Orientierung, Klarheit und Umsetzungsnähe sichtbar macht.',
    localBlurb: 'Für Beratungsangebote im Ruhrgebiet mit Fokus auf Wandel, Organisation und mittelständische Realität.'
  },
  {
    slug: 'greifswald',
    label: 'Greifswald',
    ...
    locale: 'de_DE',
    eyebrow: '📍 Unternehmensberater in Greifswald',
    cityFlavor: 'Greifswald verbindet Hochschulumfeld, Gesundheitswirtschaft, maritime Nähe und regionale Unternehmen mit überschaubaren, aber anspruchsvollen Märkten. Für Unternehmensberater ist eine fokussierte Landingpage hier besonders wertvoll, weil Vertrauen, Spezialisierung und Relevanz schnell erkennbar sein müssen.',
    localBlurb: 'Für Beratungsangebote in Vorpommern mit Fokus auf Klarheit, Vertrauen und spezialisierte B2B-Leistungen.'
  },
  {
    slug: 'halle',
    label: 'Halle',
    ...
    locale: 'de_DE',
    eyebrow: '📍 Unternehmensberater in Halle',
    cityFlavor: 'Halle an der Saale vereint Wissenschaft, Chemie-, Logistik- und Dienstleistungsumfeld mit einem breiten regionalen Mittelstand. Unternehmensberater brauchen dort eine Präsenz, die Leistungen klar strukturiert und aus abstrakter Beratung ein nachvollziehbares Angebot macht.',
    localBlurb: 'Für Beratungsangebote in Halle mit Fokus auf Mittelstand, Struktur und wirtschaftliche Entwicklung.'
  },
  {
    slug: 'herne',
    label: 'Herne',
    state: 'Nordrhein-Westfalen',
    locale: 'de_DE',
    eyebrow: '📍 Unternehmensberater in Herne',
    cityFlavor: 'Herne ist Teil des dichten Ruhrgebietsmarkts, in dem viele Dienstleistungen um Aufmerksamkeit konkurrieren. Für Unternehmensberater ist deshalb entscheidend, die eigene Positionierung lokal und verständlich darzustellen — nicht mit Floskeln, sondern mit einer klaren Angebotsseite, die Nutzen und Fokus greifbar macht.',
    localBlurb: 'Für Unternehmensberatung im Ruhrgebiet mit klarer Positionierung für Mittelstand und Transformationsfragen.'
  },
  {
    slug: 'jena',
    label: 'Jena',
    state: 'Thüringen',
    locale: 'de_DE',
    eyebrow: '📍 Unternehmensberater in Jena',
    cityFlavor: 'Jena ist Technologie-, Wissenschafts- und Innovationsstandort mit anspruchsvollen Zielgruppen und hoher Spezialisierungsdichte. Gerade deshalb brauchen Unternehmensberater eine Landingpage, die strategische Beratung verständlich macht und Professionalität ohne unnötige Komplexität zeigt.',
    localBlurb: 'Für Beratungsangebote in Jena mit Fokus auf Technologie, Wachstum und strategische Klarheit.'
  }
];
...
function updateLandingpagesIndex() {
  ...
  let html = fs.readFileSync(file, 'utf8');
  if (html.includes('DE Gap-Fill-Cluster: Unternehmensberater Batch 3')) return false;
  const anchor = '</main>';
  const section = `<section class="section"><div class="card"><h2>DE Gap-Fill-Cluster: Unternehmensberater Batch 3</h2><p>Der nächste saubere Gap-Fill-Batch ergänzt fünf weitere deutsche Städte, in denen der lokale B2B-Cluster bereits vorhanden war, die Companion-Seite für <strong>Unternehmensberater</strong> aber noch fehlte. So wird die Abdeckung systematisch verdichtet, ohne bereits erledigte Städte doppelt zu bearbeiten.</p><div class="grid-3"><article class="card"><h3><a href="landingpage-gelsenkirchen-unternehmensberater.html">Unternehmensberater in Gelsenkirchen</a></h3><p>Für Beratungsangebote im Ruhrgebiet mit Fokus auf Wandel, Organisation und mittelständische Realität.</p></article><article class="card"><h3><a href="landingpage-greifswald-unternehmensberater.html">Unternehmensberater in Greifswald</a></h3><p>Für Beratungsangebote in Vorpommern mit Fokus auf Klarheit, Vertrauen und spezialisierte B2B-Leistungen.</p></article><article class="card"><h3><a href="landingpage-halle-unternehmensberater.html">Unternehmensberater in Halle</a></h3><p>Für Beratungsangebote in Halle mit Fokus auf Mittelstand, Struktur und wirtschaftliche Entwicklung.</p></article><article class="card"><h3><a href="landingpage-herne-unternehmensberater.html">Unternehmensberater in Herne</a></h3><p>Für Unternehmensberatung im Ruhrgebiet mit klarer Positionierung für Mittelstand und Transformationsfragen.</p></article><article class="card"><h3><a href="landingpage-jena-unternehmensberater.html">Unternehmensberater in Jena</a></h3><p>Für Beratungsangebote in Jena mit Fokus auf Technologie, Wachstum und strategische Klarheit.</p></article></div></div></section>`;
