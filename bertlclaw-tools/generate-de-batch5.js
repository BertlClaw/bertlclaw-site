#!/usr/bin/env node
/**
 * generate-de-batch5.js
 * Generates city×profession landing pages for German cities (batch 5).
 * Cities: 20 (NRW-Ruhr, Baden-Württemberg, Hessen)
 * Professions: 25
...
const cities = [
  ...
  {city: "Bonn", slug: "bonn", state: "Nordrhein-Westfalen", locale: "de_DE"},
  ...
  {city: "Dortmund", slug: "dortmund", state: "Nordrhein-Westfalen", locale: "de_DE"},
  ...
  {city: "Ulm", slug: "ulm", state: "Baden-Württemberg", locale: "de_DE"},
...
function getCityFlavor(city) {
  const flavors = {
    aachen: "Aachen ist eine der ältesten Städte Deutschlands und bedeutendes Hochschul- und Technologiezentrum — die RWTH Aachen, eine der renommiertesten Technischen Universitäten Europas, und eine lebhafte Startup-Szene schaffen ein ideales Umfeld für positionierte Selbstständige.",
    bonn: "Bonn, ehemalige Bundeshauptstadt und heutiger UN-Standort, ist eine wirtschaftsstarke Stadt am Rhein — mit internationaler Atmosphäre, Telekom-Hauptsitz, Universität Bonn und einer kaufkräftigen Bevölkerung, die professionelle Dienstleistungen zu schätzen weiß.",
    wuppertal: "Wuppertal mit seiner legendären Schwebebahn ist ein lebhafter Wirtschaftsstandort im Bergischen Land — mit Bergischer Universität, einem wachsenden Kreativsektor und einer soliden mittelständischen Wirtschaft, die qualifizierten Selbstständigen gute Perspektiven bietet.",
    gelsenkirchen: "Gelsenkirchen befindet sich im Wandel vom Industriestandort zur modernen Dienstleistungsstadt — mit Westfälischer Hochschule, wachsender Gründerszene und einem Markt, der Selbstständigen mit klarem Angebot in einer weniger gesättigten Umgebung attraktive Chancen bietet.",
    bochum: "Bochum ist das kulturelle Herz des Ruhrgebiets — mit Ruhr-Universität Bochum, einer der größten Universitäten Deutschlands, einer lebhaften Kulturszene und einem Markt, der sich vom Industrie- zum Dienstleistungsstandort wandelt.",
    dortmund: "Dortmund ist die größte Stadt des Ruhrgebiets und ein wichtiger Logistik-, Technologie- und Kreativstandort — mit TU Dortmund, BVB-Flair und einer dynamischen Wirtschaft, die professionellen Selbstständigen ein breites Betätigungsfeld bietet.",
    herne: "Herne liegt im Herzen des Ruhrgebiets und ist trotz kompakter Größe ein solider Wirtschaftsstandort — mit gutem Potenzial für Selbstständige, die in einem weniger umkämpften Markt mit klarer Positionierung überdurchschnittlich sichtbar werden wollen.",
    oberhausen: "Oberhausen ist bekannt durch das Centro und ein aktiver Wirtschaftsstandort im nördlichen Ruhrgebiet — mit starker Handelstradition, einem wachsenden Dienstleistungssektor und einem Markt, der professionell aufgestellten Selbstständigen gute Chancen bietet.",
    duisburg: "Duisburg ist der weltgrößte Binnenhafen und wichtiger Logistik- und Wirtschaftsstandort im westlichen Ruhrgebiet — mit Universität Duisburg-Essen, internationaler Wirtschaftsverflechtung und einem Markt, der positionierte Selbstständige in wachsenden Sektoren nachfragt.",
    mannheim: "Mannheim ist das wirtschaftliche Zentrum der Metropolregion Rhein-Neckar — mit Hochschule Mannheim, SAP-Campus in Walldorf nebenan, starker Industrie und einer lebhaften Startup-Szene, die qualifizierten Selbstständigen hervorragende Chancen bietet.",
    karlsruhe: "Karlsruhe ist das Technologie-Epizentrum Baden-Württembergs — als Stadt des Bundesverfassungsgerichts, des KIT (Karlsruher Institut für Technologie) und zahlreicher IT-Unternehmen bietet sie ein einzigartiges Umfeld für Selbstständige, die technologieaffine Kunden ansprechen.",
    ulm: "Ulm ist Geburtsort Albert Einsteins und wichtiger Technologie- und Gesundheitsstandort in Baden-Württemberg — mit Universität Ulm, Wibu-Systems, Daimler und Voith vor der Haustür bietet die Stadt ein überdurchschnittlich gut vernetztes Wirtschaftsumfeld.",
    konstanz: "Konstanz am Bodensee ist eine der lebenswertesten Städte Deutschlands — mit Universität Konstanz, HTWG und einer besonderen Lage im Dreiländereck Deutschland-Schweiz-Österreich, die für Selbstständige eine einzigartige Zielgruppe schafft.",
    reutlingen: "Reutlingen ist das wirtschaftliche Zentrum der Region Neckar-Alb und einer der wichtigsten Mittelstandsstandorte Baden-Württembergs — mit Hochschule Reutlingen, Accenture und zahlreichen Industrie- und Dienstleistungsunternehmen.",
    ludwigsburg: "Ludwigsburg ist als Residenzstadt und Teil der Stuttgarter Metropolregion ein attraktiver Wirtschaftsstandort — mit Filmakademie Baden-Württemberg, gut vernetzter Unternehmenslandschaft und einer kaufkräftigen Bevölkerung, die professionelle Dienstleistungen nachfragt.",
    esslingen: "Esslingen am Neckar liegt im Herzen der Stuttgarter Metropolregion und ist ein bedeutender Industriestandort — mit Hochschule Esslingen, traditionsreichen Unternehmen und einer dynamischen Wirtschaft, die qualifizierten Selbstständigen ein stabiles Fundament bietet.",
    sindelfingen: "Sindelfingen ist als Mercedes-Benz-Stammwerk eine der wirtschaftsstärksten Städte Baden-Württembergs pro Kopf — mit gut verdienender Bevölkerung, starker Industrie und direkter Anbindung an Stuttgart bietet die Stadt ideale Bedingungen für positionierte Selbstständige.",
    kassel: "Kassel ist die documenta-Stadt und wirtschaftliches Zentrum Nordhessens — mit Universität Kassel, Volkswagen-Werk und einer soliden Mittelstandsstruktur, die qualifizierte Selbstständige aktiv nachfragt.",
    wiesbaden: "Wiesbaden als Landeshauptstadt von Hessen ist ein bedeutender Verwaltungs-, Medien- und Finanzstandort — mit Hochschule RheinMain, zahlreichen Behörden und Unternehmen sowie einer gut situierten Bevölkerung, die Qualität schätzt.",
    darmstadt: "Darmstadt ist die Wissenschaftsstadt Hessens — mit TU Darmstadt, Merck, Software AG und ESA/ESOC bietet die Stadt ein einzigartiges Technologie- und Wissenschaftsumfeld, das Selbstständige mit klar definiertem Angebot optimal nutzen können.",
  };
